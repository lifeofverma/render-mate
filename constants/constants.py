...
STOP_ICON = icons_path / 'stop_icon.png'
STOP_ICON = STOP_ICON.as_posix()
...
OPERATION_PLAY_ICON = icons_path / 'operation_play_icon.png'
OPERATION_PLAY_ICON = OPERATION_PLAY_ICON.as_posix()

OPERATION_STOP_ICON = icons_path / 'operation_stop_icon.png'
OPERATION_STOP_ICON = OPERATION_STOP_ICON.as_posix()

OPEN_DIR_ICON = icons_path / 'opne_dir_icon.png'
OPEN_DIR_ICON = OPEN_DIR_ICON.as_posix()
